...
begin
  ...
  case TenderForm.SearchMode of
    ...
    begin
      Label1.Visible := True;
      edt1.Visible := True;
      Label1.Caption := 'Название подрядчика';
      cbb1.Visible := true;
      cbb1.Items.Add('Точное равенство');
      cbb1.Items.Add('Вхождение');
      cbb1.ItemIndex := 0;
    ...
    begin
      ...
      edt4.Visible := True;
      Label1.Caption := 'ФИО';
      Label2.Caption := 'Компания';
      Label3.Caption := 'Зарплата';
      Label4.Caption := 'Объект';
      cbb1.Visible := true;
      cbb1.Items.Add('Точное равенство');
      cbb1.Items.Add('Вхождение');
      cbb1.ItemIndex := 0;
      cbb2.Visible := true;
      cbb2.Items.Add('Точное равенство');
      cbb2.Items.Add('Вхождение');
      cbb2.ItemIndex := 0;
      cbb3.Visible := true;
      cbb3.Items.Add('=');
      cbb3.Items.Add('<');
      ...
      cbb3.ItemIndex := 0;
      cbb4.Visible := true;
      cbb4.Items.Add('Точное равенство');
      cbb4.Items.Add('Вхождение');
      cbb4.ItemIndex := 0;
    end;
  end;
end;
